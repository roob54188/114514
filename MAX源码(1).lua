...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BINjiaobzx6/BINjiao/main/XK%E7%94%A8%E6%88%B7%E7%95%8C%E9%9D%A2.txt", true))()
    local window = library:new("XK MAX【测试版】")
...
local creds = owow:Tab("自瞄", "7733666258")
    local dogsun = creds:section("请只选一个自瞄，否则会叠加", true)
...
local UITab4 = window:Tab("力量传奇",'7733747106')
local aboutxknnb = UITab4:section("传送功能",true)

aboutxknnb:Button("回到出生点",function()
...
aboutxknnb:Button("进入灾害岛",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-83.5, 38.5, -27.5, -1, 0, 0, 0, 1, 0, 0, 0, -1)
end)

local aboutpo = UITab4:section("主要功能",true)

aboutpo:Toggle("自动比赛", "AR", false, function(AR)
...
aboutpo:Toggle("自动举哑铃", "ATYL", false, function(ATYL)
